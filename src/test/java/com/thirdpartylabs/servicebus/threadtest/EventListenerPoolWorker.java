 ...
 */
public class EventListenerPoolWorker extends AbstractWorker
{
    private final List<String> receivedEvents = new ArrayList<>();
    private final EventSubscription<ApplicationActivityServiceBusEvent> subscription;


    public EventListenerPoolWorker(EventSubscription<ApplicationActivityServiceBusEvent> subscription)
    {
