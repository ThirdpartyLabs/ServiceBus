...
/**
 * Base class for requests to be issued on the RequestResponseBus
 *
 * @param <T> Type of value to be set on the response
 */
public abstract class ServiceBusRequest<T>
{
}
